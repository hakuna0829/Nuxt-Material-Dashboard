  ...
  <v-card class="mb-7">
    <v-row>
      <v-col cols="12" lg="6" sm="4" class="py-0">
        <div class="pa-5">
          <h3 class="text-truncate font-weight-regular">
            Email verification results Count
          </h3>
          <h6
            class="body-2 mb-0 blue-grey--text text--lighten-2 font-weight-light"
          >
            Distribution of the statuses across your verified emails
          </h6>
        </div>
      </v-col>
      <v-col cols="12" lg="3" sm="4" class="border-right py-0">
        <!-- <div class="d-flex align-items-center pa-5">
          <div class="mx-3">
            ...
            <h5
              class="blue-grey--text text--lighten-2 font-weight-regular subtitle-1"
            >
              Growth
            </h5>
          </div>
